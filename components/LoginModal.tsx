...
import { X, Mail, Lock, User, Eye, EyeOff, AlertCircle, Sprout, ShieldAlert, Loader2 } from 'lucide-react';
import { signInWithPassword, signUpWithPassword, AuthResult } from '../services/auth';
